...
@can('submit-letter-of-recommendation')
    <li class="sidebar-item {{ request()->routeIs('submissions.*') || request()->routeIs('submission.createForm') ? 'active' : '' }}">
        ...
        <ul id="submissions"
            ...
            <li class="sidebar-item {{ request()->routeIs('submissions.create') || request()->routeIs('submission.createForm') ? 'active' : '' }}">
