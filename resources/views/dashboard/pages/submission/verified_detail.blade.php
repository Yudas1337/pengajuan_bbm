                    ...
                    <div class="tab-content" id="tab-wizard">
                        <div id="input-submission-data" class="tab-pane" role="tabpanel"
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Nomor Surat Pengajuan <small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ $submission->letter_number }}" autocomplete="off"
                                        name="letter_number" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Tanggal Surat Pengajuan <small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ $submission->date }}" autocomplete="off" name="date"
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Tanggal Mulai<small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ date('Y-m-d\TH:i', strtotime($submission->start_time)) }}"
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Tanggal Selesai<small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ date('Y-m-d\TH:i', strtotime($submission->end_time)) }}"
                        ...
                        <div id="input-detail-data" class="tab-pane" role="tabpanel" style="display: none;">
                            <div class="mb-3 row error-placeholder">
                                ...
                                <div class="col-sm-6">
                                    <label class="form-check">
                                        <input disabled {{ $submission->equipment_type == 'Kapal' ? 'checked' : '' }}
                                            value="Kapal" name="equipment_type" type="radio"
                                            class="form-check-input">
                                        <span class="form-check-label">Kapal</span>
                                    </label> <label class="form-check">
                                        <input disabled {{ $submission->equipment_type == 'Pompa' ? 'checked' : '' }}
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Jumlah Alat<small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ $submission->total_equipment }}" autofocus
                                        autocomplete="off" name="total_equipment" type="number" class="form-control">
                                </div>
                            </div>
                            <div class="mb-3 row error-placeholder">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <label class="form-check">
                                        <input disabled
                                            {{ $submission->equipment_function === 'Pengairan' ? 'checked' : '' }}
                                    ...
                                    <label class="form-check">
                                        <input disabled
                                            {{ $submission->equipment_function === 'Nelayan' ? 'checked' : '' }}
                            ...
                            <div class="mb-3 row error-placeholder">
                                ...
                                <div class="col-sm-6">
                                    <label class="form-check">
                                        <input disabled {{ $submission->fuel_type === 'Solar' ? 'checked' : '' }}
                                            name="fuel_type" value="Solar" type="radio" class="form-check-input">
                                        <span class="form-check-label">Solar</span>
                                    </label>
                                    <label class="form-check">
                                        <input disabled {{ $submission->fuel_type === 'Premium' ? 'checked' : '' }}
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Kebutuhan Setiap Alat<small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ $submission->equipment_needed }}" autocomplete="off"
                            ...
                            <div class="mb-3 row error-placeholder">
                                ...
                                <div class="col-sm-6">
                                    <input disabled
                                        value="{{ date('Y-m-d\TH:i', strtotime($submission->equipment_uptime)) }}"
                            ...
                            <div class="mb-3 row error-placeholder">
                                ...
                                <div class="col-sm-6">
                                    <label class="form-check">
                                        <input disabled {{ $submission->time_unit == 'hour' ? 'checked' : '' }}
                                            value="hour" name="time_unit" type="radio" class="form-check-input">
                                        <span class="form-check-label">Jam</span>
                                    </label>
                                    <label class="form-check">
                                        <input disabled {{ $submission->time_unit == 'day' ? 'checked' : '' }}
                                            value="day" name="time_unit" type="radio" class="form-check-input">
                                        <span class="form-check-label">Hari</span>
                                    </label>
                                    <label class="form-check">
                                        <input disabled {{ $submission->time_unit == 'week' ? 'checked' : '' }}
                                            value="week" name="time_unit" type="radio" class="form-check-input">
                                        <span class="form-check-label">Minggu</span>
                                    </label>
                                    <label class="form-check">
                                        <input disabled {{ $submission->time_unit == 'month' ? 'checked' : '' }}
                                            value="month" name="time_unit" type="radio" class="form-check-input">
                            ...
                            <div class="mb-3 row error-placeholder">
                                <label class="col-form-label col-sm-3 text-sm-right">Formula<small
                                        class="text-danger">*</small> </label>
                                <div class="col-sm-6">
                                    <input disabled value="{{ $submission->formula }}" autocomplete="off" name="formula"
