    ...
    <div class="container page">
        ...
        <div class="row" style="margin-top: 1rem">
            <div class="text-center no-surat">
                <h6 class="fw-bold text-decoration-underline" style="font-size: 11pt; margin: 0">SURAT REKOMENDASI
                    PEMBELIAN JENIS BBM TERTENTU (JENIS MINYAK SOLAR)</h6>
                <p style="margin: 0"><span class="fw-bold">Nomor :
                    </span>523/................./437.60/{{ date('Y') }}</p>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <ol start="1">
                            ...
                            <li class="fw-bold">Peraturan Presiden Nomor 191 Tahun 2014 tentang penyediaan,
                                Pendistribusian dan Harga Jual Eceran Bahan Bakar Minyak sebagaimana telah diubah dengan
                                Peraturan Presiden Nomor 43 Tahun 2018 tentang Perubahan atas Peraturan Presiden Nomor
        ...
        <div class="row" style="font-size: 11pt; margin-top: 1rem">
            <ol start="1">
                <li>Bedasarkan hasil berifikasi, Kebutuhan BBM digunakan untuk sarana sebagai berikut :
                    <table class="table table-bordered text-center" style="vertical-align: middle">
                        ...
                        <tr>
                            <td>1.</td>
                            <td>Mesin Diesel</td>
                            <td>{{ $submission->submission_receivers->count() }} PK &
                                {{ $submission->submission_receivers->count() }} PK</td>
                            <td>
                                @if ($submission->receiver_type == 'Nelayan')
                ...
                <li>Masa berlaku Surat Rekomendasi sampai dengan tangga.l : <span
                        class="fw-bold">{{ date('d F Y', strtotime($submission->start_time)) }} s/d
                        {{ date('d F Y', strtotime($submission->end_time)) }}.</span></li>
                <li>Apabila penggunana Surat Rekomendasi ini tidak sebagaimana mestinya, maka akan dicabut dan di
                    ditindaklanjuti dengan proses hukum sesui dengan ketentuan peraturan perundang-undangan.</li>
            </ol>
        </div>
        <div class="row footer-container">
            <div class="footer-left" style="font-size: 10pt">
                <p class="fw-bold text-decoration-underline">Catatan</p>
                <p style="line-height: 1rem">Harap tidak dilayani jika dalam pembelian BBM bersubsidi nama yang tertera
                    dalam identitas diri pembeli BBM tidak sama ataupun masa berlaku Surat Rekomendasi sudah habis.</p>
